      ...
      <div className={`style-switcher outer-shadow ${isOpen ? "open" : ""}`}>
        ...
        <div className="small-screen">
          ...
          <div className="colors">
            <span
              className="color-1"
              onClick={() => handleColorChange("#9f7aea")}
            ></span>
            <span
              className="color-2"
              onClick={() => handleColorChange("#ec9412")}
            ></span>
            <span
              className="color-3"
              onClick={() => handleColorChange("#1fc586")}
            ></span>
            <span
              className="color-4"
              onClick={() => handleColorChange("#2eb1ed")}
            ></span>
            <span
              className="color-5"
              onClick={() => handleColorChange("#cc3a3b")}
            ></span>
          </div>
        </div>
      </div>
